...
class FeatureClass:
    ...
    def extract_file_feature(self, _arg_in):
        ...
        _wav_path_new = str(_wav_path)
        if 'foa' in _wav_path_new:
            if 'fold14' in _wav_path_new or 'fold24' in _wav_path_new or 'fold34' in _wav_path_new or 'fold44' in _wav_path_new:
                spect[:, :, 1] = -spect[:, :, 1]
                spect[:, :, 2] = -spect[:, :, 2]
            elif 'fold11' in _wav_path_new or 'fold21' in _wav_path_new or 'fold31' in _wav_path_new or 'fold41' in _wav_path_new:
                spect[:, :, [0, 1, 2, 3]] = spect[:, :, [0, 3, 2, 1]]
                spect[:, :, 1] = -spect[:, :, 1]
                spect[:, :, 2] = -spect[:, :, 2]
            elif 'fold12' in _wav_path_new or 'fold22' in _wav_path_new or 'fold32' in _wav_path_new or 'fold42' in _wav_path_new:
                spect[:, :, [0, 1, 2, 3]] = spect[:, :, [0, 3, 2, 1]]
                spect[:, :, 1] = -spect[:, :, 1]
                spect[:, :, 3] = -spect[:, :, 3]
            elif 'fold15' in _wav_path_new or 'fold25' in _wav_path_new or 'fold35' in _wav_path_new or 'fold45' in _wav_path_new:
                spect[:, :, [0, 1, 2, 3]] = spect[:, :, [0, 3, 2, 1]]
                spect[:, :, 2] = -spect[:, :, 2]
                spect[:, :, 3] = -spect[:, :, 3]
            elif 'fold16' in _wav_path_new or 'fold26' in _wav_path_new or 'fold36' in _wav_path_new or 'fold46' in _wav_path_new:
                spect[:, :, [0, 1, 2, 3]] = spect[:, :, [0, 3, 2, 1]]
            elif 'fold17' in _wav_path_new or 'fold27' in _wav_path_new or 'fold37' in _wav_path_new or 'fold47' in _wav_path_new:
                spect[:, :, 1] = -spect[:, :, 1]
                spect[:, :, 3] = -spect[:, :, 3]
            elif 'fold18' in _wav_path_new or 'fold28' in _wav_path_new or 'fold38' in _wav_path_new or 'fold48' in _wav_path_new:
                spect[:, :, 2] = -spect[:, :, 2]
                spect[:, :, 3] = -spect[:, :, 3]
