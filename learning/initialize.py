...
from utils.config import get_generator, store_config, get_losses, get_afextractor, get_models, get_optimizer, \
    get_metrics, get_trainer
...
def init_train(args, cfg, dataset):
    ...
    lr_scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=cfg['training']['lr_step_size'], gamma=cfg['training']['lr_gamma'])
