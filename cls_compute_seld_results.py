...
class ComputeSELDResults(object):
    ...
    def get_SELD_Results(self, pred_files_path, is_jackknife=False):
        ...
        if is_jackknife:
            ...
            return [ER, conf_interval[0]], [F, conf_interval[1]], [LE, conf_interval[2]], [LR, conf_interval[3]], [seld_scr, conf_interval[4]], [classwise_results, np.array(conf_interval)[5:].reshape(5,12,2) if len(classwise_results) else []]
